...
if($total_pop != 0) $p_male = (($c_male/$total_pop) * 100); else $p_male = 0;
if($total_pop != 0) $p_female = (($c_female/$total_pop) * 100); else $p_female = 0;
...
if($total_age_pop != 0) $p_children = (($c_children/$total_age_pop) * 100); else $p_children = 0;
if($total_age_pop != 0) $p_adults = (($c_adults/$total_age_pop) * 100); else $p_adults = 0;
if($total_age_pop != 0) $p_senior = (($c_senior/$total_age_pop) * 100); else $p_senior = 0;
