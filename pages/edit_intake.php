...
$questions = $db_handle->runFetch("SELECT * FROM `questions` LEFT JOIN html_form ON html_form.HTML_FORM_ID = questions.HTML_FORM_HTML_FORM_ID WHERE INTAKE_IntakeID = ".$id);
...
$form_info = $db_handle->runFetch("SELECT * FROM `intake` WHERE IntakeID = ".$id);
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="header">
                            <div class="col-md-12">
                                <h3><?php if(!empty($form_info)) { foreach ($form_info as $info) { if($info['AgeGroup'] === '1') {
                            ...
                            <div class="col-md-12">
                                <h5>(IDP details will show here)</h5>
                            </div>
                            <div class="col-md-12">
                        ...
                        <div class="content">
                            <div class="form-group">
                                ...
                                <form id="form-layout" target="" action="" onsubmit="return validate_forms()" method="post">
                                    ...
                                    <input type="hidden" name="isIntake" value="intake">
                                    <br>
                                    <table align="center" cellspacing="3" cellpadding="3" width="90%" class="table-responsive">
                                        <tr>
